...
A detailed description of this dataset can be found in [```desc/datasets_description_ru.pdf```](https://github.com/sberbank-ai/no_flood_with_ai_aij2020/blob/main/desc/datasets_description_ru.pdf)
